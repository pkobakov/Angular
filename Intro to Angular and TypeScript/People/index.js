...
var Junior = /** @class */ (function (_super) {
    ...
    function Junior(name, age) {
        ...
        _this.tasks.push(" is working on a simple tasks");
        return _this;
    }
    return Junior;
}(Employee));
...
var Manager = /** @class */ (function (_super) {
    ...
    function Manager(name, age) {
        var _this = _super.call(this, name, age) || this;
        _this.divident = 0;
        _this.tasks.push(' sheduled a meeting.');
...
var junior = new Junior('Dimitrichko', 43);
junior.salary = 1500;
junior.collectSalary();
junior.work();
var senior = new Senior('Gosho', 33);
senior.salary = 3500;
senior.collectSalary();
senior.work();
senior.work();
senior.work();
var manager = new Manager('Pesho', 50);
manager.salary = 5000;
